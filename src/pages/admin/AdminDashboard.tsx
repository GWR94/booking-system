...
import { AnimateIn, LoadingSpinner, SectionHeader } from '@ui';
import {
	...
	return (
		<Box sx={{ maxWidth: 1200, mx: 'auto', px: { xs: 2, md: 4 }, py: 4 }}>
			<SectionHeader
				...
				description="Real-time insights and platform metrics"
				noAnimation
			/>
			...
			<Grid container spacing={4}>
				<Grid size={{ xs: 12, md: 7 }}>
					<AnimateIn type="fade-up" delay={0.4} style={{ height: '100%' }}>
						<Paper
							elevation={0}
							sx={{
								p: 4,
							...
							>
								...
								<Box sx={{ flex: 1 }}>
									...
									<Typography variant="body2" color="text.secondary">
										...
										today. Ensure all bays are prepared for the influx of
										players.
									</Typography>
								</Box>
							</Box>
				...
				<Grid size={{ xs: 12, md: 5 }}>
					<AnimateIn type="fade-up" delay={0.5} style={{ height: '100%' }}>
						<Paper
							elevation={0}
							sx={{
								p: 4,
