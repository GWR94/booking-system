		...
		<Container maxWidth="lg">
			...
			<Box sx={{ mb: 4 }}>
				...
				>
					...
					<AccordionDetails>
						<Typography variant="body1">
							...
							filling in forms. These include:
						</Typography>
						<ul>
				...
				>
					...
					<AccordionDetails>
						...
						<ul>
							<Typography component="li" variant="body1">
								Cookies that remember your preferences (e.g., language settings)
							</Typography>
							<Typography component="li" variant="body1">
				...
				>
					...
					<AccordionDetails>
						<Typography variant="body1">
							...
							visitors move around the site. These include:
						</Typography>
						<ul>
							<Typography component="li" variant="body1">
				...
				>
					<AccordionSummary expandIcon={<ExpandMore />}>
						<Typography sx={{ fontWeight: 500 }}>Marketing Cookies</Typography>
					</AccordionSummary>
					<AccordionDetails>
						<Typography variant="body1">
						...
						<Typography variant="body1" sx={{ mt: 2 }}>
							These cookies do not store directly personal information, but are
							based on uniquely identifying your browser and internet device. If
			...
			<Box sx={{ mb: 4 }}>
				...
				<Typography variant="body1" sx={{ mb: 2 }}>
					You can set your cookie preferences below. Note that essential cookies
			...
			<Box sx={{ mb: 4 }}>
				...
				<Typography variant="body1">
					We may update our Cookie Policy from time to time. Any changes we make
					to our Cookie Policy in the future will be posted on this page and,
