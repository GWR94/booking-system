		...
		<Container maxWidth="lg">
			...
			<Box sx={{ mb: 4 }}>
				...
				<Typography variant="body1">
					...
					Site, and you waive the right to receive specific notice of each such
					change.
				</Typography>
			</Box>
			...
			<Box sx={{ mb: 4 }}>
				...
				<Typography variant="body1">
					...
					telephone number, and billing information that you voluntarily give to
					us when you register with the Site or when you choose to participate
					in various activities related to the Site. You are under no obligation
			...
			<Box sx={{ mb: 4 }}>
				...
				<Typography variant="body1">
					...
					to us, please be aware that despite our efforts, no security measures
			...
			<Box sx={{ mb: 4 }}>
				...
				<Typography variant="body1">
					...
					For more information on how we use cookies, please refer to our Cookie
				...
				<Typography variant="body1">
					...
					the availability and functionality of our Site.
				</Typography>
			</Box>
			...
			<Box sx={{ mb: 4 }}>
				...
				<ul>
					...
					<Typography component="li" variant="body1">
						Personal injury or property damage resulting from your access to or
						use of our service;
					</Typography>
					<Typography component="li" variant="body1">
