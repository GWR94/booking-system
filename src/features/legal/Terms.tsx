...
import { Box, Typography, Divider, useTheme, Container } from '@mui/material';
		...
		<Container maxWidth="lg">
			...
			<Box sx={{ mb: 4 }}>
				...
				<Typography variant="body1" gutterBottom>
					...
					The Short Grass ("we," "us" or "our"), concerning your access to and
			...
			<Box sx={{ mb: 4 }}>
				...
				<Typography variant="body1">
					...
					agreement. All bookings are subject to availability and confirmation.
				</Typography>
				...
				<Typography variant="body1">
					...
					page. All prices are listed in GBP and include applicable taxes unless
					otherwise stated.
				</Typography>
				...
				<Typography variant="body1">
					...
					time will receive a full refund. Cancellations made less than 24 hours
					before the scheduled time will incur a 50% cancellation fee. No-shows
					will be charged the full amount with no refund.
				</Typography>
			...
			<Box sx={{ mb: 4 }}>
				...
				<Typography variant="body1">
					Users must conduct themselves in an appropriate manner while using our
					facilities. We reserve the right to refuse service or remove any
				...
				<Typography variant="body1">
					Users are responsible for the proper use of all equipment provided in
					the simulator bays. Any damage caused by improper use or negligence
					will be the financial responsibility of the user.
				</Typography>
			...
			<Box sx={{ mb: 4 }}>
				...
				<Typography variant="body1">
					...
					and will remain the exclusive property of The Short Grass and its
				...
				<Typography variant="body1">
					...
					product or service without the prior written consent of The Short
					Grass.
				</Typography>
			</Box>
